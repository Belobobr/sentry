...
const asyncContainer = (Typeahead) => {
    class WrappedTypeahead extends React.Component {
        constructor(props) {
            super(props);
            this._getEmptyLabel  = this._getEmptyLabel.bind(this);
        ...
        _handleSearch (query) {
            ...
            if (query === null || query === undefined || (minLength && query.length < minLength)) {
                return;
            }
    ...
    WrappedTypeahead.displayName = `AsyncContainer(Typeahead)`;
